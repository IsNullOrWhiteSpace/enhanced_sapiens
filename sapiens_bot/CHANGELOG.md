...
### Chore
 ...
 - <csr-id-2f6bd679cd73d0fbde7293d7d56d64b5abb54b51/> bump serenity from 0.11.6 to 0.11.7
   Bumps [serenity](https://github.com/serenity-rs/serenity) from 0.11.6 to 0.11.7.
   ...
   - [Commits](https://github.com/serenity-rs/serenity/compare/v0.11.6...v0.11.7)
 ...
 - <csr-id-5d6e571ad7141d0c1a243479f7af36c34a8ab341/> bump insta from 1.31.0 to 1.32.0
   ...
   - dependency-name: insta
     ...
     update-type: version-update:semver-minor
   ...
 - <csr-id-86f4f6b3c532950d83706dcaa9be09127336b84b/> bump indoc from 2.0.3 to 2.0.4
 ...
 - <csr-id-78a1156d0427bd0b730cc48fc4f3b56b03a2b241/> bump tokio from 1.31.0 to 1.32.0
   ...
   - dependency-name: tokio
     ...
     update-type: version-update:semver-minor
   ...
 - <csr-id-c0892fa115b2d668c627f49d28b120ae6f015161/> bump pulldown-cmark-to-cmark from 10.0.4 to 11.0.0
 ...
 - <csr-id-c19e63b86012b4daef662b28793f4f5c97c05e2f/> bump insta from 1.30.0 to 1.31.0
   ...
   - dependency-name: insta
     ...
     update-type: version-update:semver-minor
   ...
 - <csr-id-a140d6dbe124c94f2bc2171029b43d681c4490f9/> bump indoc from 2.0.2 to 2.0.3
 ...
 - <csr-id-13a2a34844b4d9c69ca6d0815d1b8d51de05282b/> bump serenity from 0.11.5 to 0.11.6
   Bumps [serenity](https://github.com/serenity-rs/serenity) from 0.11.5 to 0.11.6.
   - [Release notes](https://github.com/serenity-rs/serenity/releases)
   - [Changelog](https://github.com/serenity-rs/serenity/blob/current/CHANGELOG.md)
   - [Commits](https://github.com/serenity-rs/serenity/compare/v0.11.5...v0.11.6)
...
<csr-read-only-do-not-edit/>
 ...
 - 50 commits contributed to the release over the course of 139 calendar days.
 ...
 * **Uncategorized**
    ...
    - Merge pull request #171 from ssoudan/dependabot/cargo/serenity-0.11.7 ([`25624e8`](https://github.com/ssoudan/sapiens/commit/25624e8bb0b79d654205ed5adfe78b71a7ffe5ce))
    - Bump serenity from 0.11.6 to 0.11.7 ([`2f6bd67`](https://github.com/ssoudan/sapiens/commit/2f6bd679cd73d0fbde7293d7d56d64b5abb54b51))
    ...
    - Merge pull request #143 from ssoudan/dependabot/cargo/indoc-2.0.4 ([`05e8790`](https://github.com/ssoudan/sapiens/commit/05e87908919f8733736cb72b50d20c16528906d2))
    - Bump indoc from 2.0.3 to 2.0.4 ([`86f4f6b`](https://github.com/ssoudan/sapiens/commit/86f4f6b3c532950d83706dcaa9be09127336b84b))
    ...
    - Merge pull request #118 from ssoudan/dependabot/cargo/pulldown-cmark-to-cmark-11.0.0 ([`4db40c2`](https://github.com/ssoudan/sapiens/commit/4db40c2a2b446a32b6ac6f4e1c8699b4959192c4))
    - Bump pulldown-cmark-to-cmark from 10.0.4 to 11.0.0 ([`c0892fa`](https://github.com/ssoudan/sapiens/commit/c0892fa115b2d668c627f49d28b120ae6f015161))
    ...
    - Merge pull request #86 from ssoudan/dependabot/cargo/indoc-2.0.3 ([`5c3c874`](https://github.com/ssoudan/sapiens/commit/5c3c874d32fe556973a457f16fe024fec3d0aece))
    - Bump indoc from 2.0.2 to 2.0.3 ([`a140d6d`](https://github.com/ssoudan/sapiens/commit/a140d6dbe124c94f2bc2171029b43d681c4490f9))
    ...
    - Merge pull request #66 from ssoudan/dependabot/cargo/serenity-0.11.6 ([`6a6431e`](https://github.com/ssoudan/sapiens/commit/6a6431ec33b456d9d4a2b52ce1a78047ff512720))
    - Bump serenity from 0.11.5 to 0.11.6 ([`13a2a34`](https://github.com/ssoudan/sapiens/commit/13a2a34844b4d9c69ca6d0815d1b8d51de05282b))
